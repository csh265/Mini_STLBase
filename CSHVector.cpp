...
int main()
{
    ...
    //初始化容器类
    CSHvector<int> cshvector;//为何需要这样操作
    ...
    for(int i=0;i<n;i++)
    {
        ...
        if(command == "push")
        {
            int element;
            std::cin>>element;
            cshvector.push_back(element);
            cshvector.print();
        }
        else if(command == "size")
        {
            std::cout<<cshvector.getSize()<<std::endl;
        }
        else if(command == "get")
        {
            int index;
            std::cin>>index;
            std::cout<<cshvector[index]<<std::endl;//这个地方的使用看看
        }
        else if(command == "insert")
        {
            int index,element;
            std::cin>>index>>element;
            cshvector.insert(index,element);
            cshvector.print();
        }
        else if(command == "pop")
        {
        ...
        else if(command == "popIndex")
        {
            int index;
            std::cin>>index;
            cshvector.popIndex(index);
            cshvector.print();
        }
